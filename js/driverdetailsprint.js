// Event listener for the print button
    document.querySelector('.print-btn').addEventListener('click', function () {
        ...
        printWindow.document.write('.driver-info { display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 20px; border: 1px solid #ddd; padding: 10px; border-radius: 8px; }'); // Added border here
        ...
        printWindow.document.write('.info-right { flex: 1; text-align: center; display: flex; justify-content: center; align-items: flex-start; }'); // Adjusted alignment here
        printWindow.document.write('.info-right img { width: 120px; height: 120px; border-radius: 50%; border: 2px solid #ddd; object-fit: cover; margin-top: 20px; }'); // Added margin-top to move the photo down
