                ...
                <div class="profile-container">
                    ...
                    <div class="profile-section">
                        <div class="profile-image">
                            <img src="<?php echo htmlspecialchars($driver['photo'] ?? '../icons/default.jpg'); ?>" alt="Profile Picture">
                        </div>
    ...
    <div class="modal-content">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="contact_number" name="contact_number" value="<?php echo htmlspecialchars($driver['contact_number']); ?>" required>
            </div>
